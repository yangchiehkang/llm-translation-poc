...
def set_base_env(env: dict) -> dict:
    ...
    env.setdefault("HF_HOME", "/data/SERVICE_USER/models/huggingface")
    env.setdefault("HUGGINGFACE_HUB_CACHE", "/data/SERVICE_USER/models/huggingface/hub")
    env.setdefault("TRANSFORMERS_CACHE", "/data/SERVICE_USER/models/huggingface/transformers")
    env.setdefault("TORCH_HOME", "/data/SERVICE_USER/models/torch")
    env.setdefault("COMET_CACHE", "/data/SERVICE_USER/models/comet")

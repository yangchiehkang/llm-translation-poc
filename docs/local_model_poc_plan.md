...
LLM_MODELS_HOME=/data/llm_models
HF_HOME=/data/llm_models/hf_home
TRANSFORMERS_CACHE=/data/llm_models/hf_home
HF_HUB_CACHE=/data/llm_models/hf_home/hub
MODELSCOPE_CACHE=/data/llm_models/modelscope
TORCH_HOME=/data/llm_models/torch_cache
```
